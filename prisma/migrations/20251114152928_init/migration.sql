...
CREATE TABLE "Order" (
    ...
    "customerEmail" TEXT,
    "regionId" TEXT,
    "isAvailableToAll" BOOLEAN NOT NULL DEFAULT false,
    "driverId" TEXT,
    "car_id" TEXT,
...
-- CreateTable
CREATE TABLE "DistanceBreakpoint" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "DistanceBreakpoint_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "CarOption_carId_optionId_key" ON "CarOption"("carId", "optionId");

-- CreateIndex
CREATE UNIQUE INDEX "Order_paymentIntentId_key" ON "Order"("paymentIntentId");

-- CreateIndex
CREATE INDEX "Order_bookingCode_idx" ON "Order"("bookingCode");
...
-- CreateIndex
CREATE UNIQUE INDEX "DistanceBreakpoint_regionId_distanceKm_key" ON "DistanceBreakpoint"("regionId", "distanceKm");
...
-- AddForeignKey
ALTER TABLE "Car" ADD CONSTRAINT "Car_vehicle_type_id_fkey" FOREIGN KEY ("vehicle_type_id") REFERENCES "VehicleType"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CarOption" ADD CONSTRAINT "CarOption_carId_fkey" FOREIGN KEY ("carId") REFERENCES "Car"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CarOption" ADD CONSTRAINT "CarOption_optionId_fkey" FOREIGN KEY ("optionId") REFERENCES "OrderOption"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "DistanceBreakpoint" ADD CONSTRAINT "DistanceBreakpoint_regionId_fkey" FOREIGN KEY ("regionId") REFERENCES "Region"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PayoutRequest" ADD CONSTRAINT "PayoutRequest_driverId_fkey" FOREIGN KEY ("driverId") REFERENCES "DriverProfile"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PayoutRequest" ADD CONSTRAINT "PayoutRequest_processedByOperatorId_fkey" FOREIGN KEY ("processedByOperatorId") REFERENCES "OperatorProfile"("id") ON DELETE SET NULL ON UPDATE CASCADE;
